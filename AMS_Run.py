    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'E:/Face Recognition/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"E:/Face Recognition/Face-Recognition-Attendance-System-main/Attendanc/Manually Attendance/-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'E:/Face Recognition/Face-Recognition-Attendance-System-main/' + fileName
    ...
    def Attf():
        import subprocess
        folder_path = r'E:\Face Recognition\Face-Recognition-Attendance-System-main\Attendance'
...
# Get a list of all CSV files in the folder
    ...
    # Open the latest CSV file in the default application
        subprocess.Popen(['explorer', '/select,', latest_csv])
    ...
    def log_in():
        ...
        if username == 'aarya':
            if password == 'aarya123':
                ...
                cs = 'E:/Face Recognition/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
